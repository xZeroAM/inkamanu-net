...
namespace proyecto_inkamanu_net.Controllers
{
    ...
    public class PedidoController : Controller
    {
        ...
        public ActionResult ListaDePedidos(int? page)
        {
            ...
            int pageSize = 1; // maximo 3 productos por pagina
        ...
        [HttpGet("ExportarPedidosEnExcel")]
        public IActionResult ExportarPedidosEnExcel()
        {
            try
            {
                ...
                worksheet.Cells[3, 1].LoadFromCollection(_context.DataPedido.ToList(), true);
        ...
        public IActionResult ExportarUnSoloPedidoEnPDF(int id)
        {
            try
            {
        ...
        public IActionResult ExportarUnSoloPedidoEnExcel(int id)
        {
            try
            {
                var pedido = _context.DataPedido.Find(id);
                ...
                var pedidoList = new List<Pedido> { pedido };
                worksheet.Cells[3, 1].LoadFromCollection(pedidoList, true);
